...
var Pokemon = /*#__PURE__*/function () {
  ...
  _createClass(Pokemon, [{
    ...
    value: function atacar(nomeAtaque) {
      console.log("".concat(this.nome, " usou ").concat(nomeAtaque));
    }
  }, {
    key: "recebeuAtaque",
    value: function recebeuAtaque() {
      console.log("".concat(this.nome, " Recebeu um ataque"));
      _classPrivateFieldSet(this, _hp, _classPrivateFieldGet(this, _hp) - 15);
    }
  }, {
    key: "exibeHp",
    value: function exibeHp() {
      console.log('Nivel de Hp:', _classPrivateFieldGet(this, _hp));
    }
  }]);
  return Pokemon;
}(); // const pikachu = new Pokemon('Pikachu', 'elétrico');
...
var Pikachu = /*#__PURE__*/function (_Pokemon) {
  ...
  function Pikachu() {
    ...
    return _super.call(this, 'Pikachu', 'elétirco');
  }
  _createClass(Pikachu, [{
    key: "atacar",
    value: function atacar() {
      console.log("".concat(this.nome, " usou choquedo do trov\xE3o !"));
    }
  }]);
  return Pikachu;
}(Pokemon);
